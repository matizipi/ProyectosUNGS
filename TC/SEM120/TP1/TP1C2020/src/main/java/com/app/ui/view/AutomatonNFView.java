...
public class AutomatonNFView extends AutomatonFrame {
	...
	public AutomatonNFView() {
		...
		this._btnLoadFile.setBounds( this._txtFilePath.getX() + this._txtFilePath.getWidth() + this.spX
				, spY
				, 70
				, 27);
		...
		this._btnConvertToDFA.setBounds( this._btnLoadFile.getX() + this._btnLoadFile.getWidth() + this.spX
				, spY
				, 110
				, 27);
		...
		this._btnReturn.setBounds( this._realframeW - this.spX - 70
				, this.spY
				, 70
				, this.fldH );
		...
		this._spAlphabet.setBounds( this.spX
				, this._maintablesY
				, 80
				, this._maintablesH );
		...
		this._spStates.setBounds( this._spAlphabet.getX() + this._spAlphabet.getWidth() + this.spX
				, this._maintablesY
				, 180
				, this._maintablesH );
		...
		this._spTransactionFunction.setBounds( this._spStates.getX() + this._spStates.getWidth() + this.spX
				, this._maintablesY
				, this._realframeW - this._spStates.getX() - this._spStates.getWidth() - ( 2 * this.spX )
				, this._maintablesH );
...
//		this._tblTransactionFunction.setAutoResizeMode( JTable.AUTO_RESIZE_OFF );
		...
		this._spLog.setBounds( this.spX
				...
				, this._realframeH - this._spAlphabet.getY() - this._spAlphabet.getHeight() - ( 2 * spY ) );
