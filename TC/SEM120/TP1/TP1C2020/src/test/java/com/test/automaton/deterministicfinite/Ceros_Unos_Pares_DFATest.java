...
class Ceros_Unos_Pares_DFATest {
	...
	void automatonAccept_0() {
		boolean condition = _deterministicAutomaton.accept( new Input( "0" ) );
	...
	void automatonAccept_00() {
		boolean condition = _deterministicAutomaton.accept( new Input( "00" ) );
	...
	void automatonAccept_001() {
		boolean condition = _deterministicAutomaton.accept( new Input( "001" ) );
	...
	void automatonAccept_1010() {
		boolean condition = _deterministicAutomaton.accept( new Input( "1010" ) );
	...
	void automatonAccept_1100() {
		boolean condition = _deterministicAutomaton.accept( new Input( "1100" ) );
	...
	void automatonAccept_0011() {
		boolean condition = _deterministicAutomaton.accept( new Input( "0011" ) );
